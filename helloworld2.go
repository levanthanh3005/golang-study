...
func main() {
    ...
    // studyJson()
    fmt.Println(getJSONValue2(`{"Name":"Wednesday","Age":6,"Parents":["Gomez","Morticia"]}`,"Name"))
    m := stringToMap(`{"Name":"Wednesday","Age":6,"Parents":["Gomez","Morticia"]}`)
    m["Test"] = 10
    fmt.Println(objToString(m))
}